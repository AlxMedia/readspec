<?php
function readspec_get_meta_box( $meta_boxes ) {
...
/* ------------------------------------ */	
	$meta_boxes[] = array(
		'id' => 'page-options',
		'title' => esc_html__( 'Page Options', 'readspec' ),
		...
		'fields' => array(
			array(
				...
				'name' => esc_html__( 'Primary Sidebar', 'readspec' ),
				'type' => 'select',
			...
			array(
				...
				'name' => esc_html__( 'Secondary Sidebar', 'readspec' ),
				'type' => 'select',
				'placeholder' => esc_html__( 'Select a sidebar', 'readspec' ),
				'options' => $sidebars_choices,
			),
			array(
				'id' => $prefix . 'layout',
				'type' => 'image_select',
				'name' => esc_html__( 'Layout', 'readspec' ),
				'std' => 'inherit',
				'force_delete' => false,
				'max_file_uploads' => '4',
				'options' => array(
...
/* ------------------------------------ */	
	$meta_boxes[] = array(
		'id' => 'post-options',
		'title' => esc_html__( 'Post Options', 'readspec' ),
...
add_filter( 'rwmb_meta_boxes', 'readspec_get_meta_box' );