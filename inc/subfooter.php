			...
			<div class="container-inner">
				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="credit">
							<p><?php esc_html_e('Powered by','readspec'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. <?php esc_html_e('Theme by','readspec'); ?> <a href="http://alx.media" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
