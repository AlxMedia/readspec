...
2. Type in Readspec in the search form and press the 'Enter' key on your keyboard.
...
Readspec WordPress Theme, Copyright 2021 AlxMedia
Readspec is distributed under the terms of the GNU GPL
...
Readspec bundles the following third-party resources:
...
* Changed function names from alx_ to readspec_
...
= 1.0.2 - 2015-05-20 =
* Added featured posts slider option
* Added fitvids for responsive videos
* Fixed dropdown child categories
