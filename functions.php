...
if ( ! function_exists( 'readspec_load' ) ) {
	...
	function readspec_load() {
		...
		load_theme_textdomain( 'readspec', get_template_directory().'/languages' );
...
add_action( 'after_setup_theme', 'readspec_load' );	
...
/*  Theme setup
/* ------------------------------------ */
if ( ! function_exists( 'readspec_setup' ) ) {
	
	function readspec_setup() {
		// Enable title tag
		...
		add_image_size( 'readspec-large', 720, 404, true );
		...
		register_nav_menus( array(
			'mobile' 	=> esc_html__( 'Mobile', 'readspec' ),
			'topbar' 	=> esc_html__( 'Topbar', 'readspec' ),
		) );
	}
	
}
add_action( 'after_setup_theme', 'readspec_setup' );
...
/*  Custom logo
/* ------------------------------------ */
if ( ! function_exists( 'readspec_custom_logo' ) ) {
	
	function readspec_custom_logo() {
		$defaults = array(
			'height'		=> 120,
			'width'			=> 400,
			'flex-height'	=> true,
...
add_action( 'after_setup_theme', 'readspec_custom_logo' );


/*  Custom header
/* ------------------------------------ */
if ( ! function_exists( 'readspec_custom_header' ) ) {
	
	function readspec_custom_header() {
		$args = array(
			'default-image'	=> false,
			'default-text'	=> false,
			'width'			=> 1380,
...
add_action( 'after_setup_theme', 'readspec_custom_header' );


/*  Custom background
/* ------------------------------------ */
if ( ! function_exists( 'readspec_custom_background' ) ) {
	
	function readspec_custom_background() {
		$args = array();
		add_theme_support( 'custom-background', $args );
	}
	
}
add_action( 'after_setup_theme', 'readspec_custom_background' );


/*  Deregister
/* ------------------------------------ */
if ( ! function_exists( 'readspec_deregister' ) ) {
	
	function readspec_deregister() {
		wp_deregister_style( 'wp-pagenavi' );
	}
	
}
add_action( 'wp_enqueue_scripts', 'readspec_deregister', 100 );


/*  Register sidebars
/* ------------------------------------ */	
if ( ! function_exists( 'readspec_sidebars' ) ) {
	
	function readspec_sidebars()	{
		register_sidebar(array( 'name' => esc_html__('Primary','readspec'),'id' => 'primary','description' => esc_html__("Normal full width sidebar","readspec"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>'));
		register_sidebar(array( 'name' => esc_html__('Secondary','readspec'),'id' => 'secondary','description' => esc_html__("Normal full width sidebar","readspec"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>'));
		
		if ( get_theme_mod('footer-ads') == 'on' ) { register_sidebar(array( 'name' => esc_html__('Footer Ads',"readspec"),'id' => 'footer-ads', 'description' => esc_html__("Footer ads area","readspec"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }

		if ( get_theme_mod('footer-widgets') >= '1' ) { register_sidebar(array( 'name' => esc_html__('Footer 1','readspec'),'id' => 'footer-1', 'description' => esc_html__("Widgetized footer","readspec"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '2' ) { register_sidebar(array( 'name' => esc_html__('Footer 2','readspec'),'id' => 'footer-2', 'description' => esc_html__("Widgetized footer","readspec"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '3' ) { register_sidebar(array( 'name' => esc_html__('Footer 3','readspec'),'id' => 'footer-3', 'description' => esc_html__("Widgetized footer","readspec"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
		if ( get_theme_mod('footer-widgets') >= '4' ) { register_sidebar(array( 'name' => esc_html__('Footer 4','readspec'),'id' => 'footer-4', 'description' => esc_html__("Widgetized footer","readspec"), 'before_widget' => '<div id="%1$s" class="widget %2$s">','after_widget' => '</div>','before_title' => '<h3 class="group"><span>','after_title' => '</span></h3>')); }
	}
	
}
add_action( 'widgets_init', 'readspec_sidebars' );
...
add_action( 'wp_enqueue_scripts', 'readspec_scripts' ); 


/*  Enqueue css
/* ------------------------------------ */	
if ( ! function_exists( 'readspec_styles' ) ) {
	
	function readspec_styles() {
		wp_enqueue_style( 'readspec-style', get_stylesheet_uri() );
		wp_enqueue_style( 'readspec-responsive', get_template_directory_uri().'/responsive.css' );
		wp_enqueue_style( 'readspec-font-awesome', get_template_directory_uri().'/fonts/all.min.css' );
	}
	
}
add_action( 'wp_enqueue_scripts', 'readspec_styles' );
...
/*  Layout class
/* ------------------------------------ */
if ( ! function_exists( 'readspec_layout_class' ) ) {
	
	function readspec_layout_class() {
		// Default layout
		$layout = 'col-2cl';
		$default = 'col-2cl';
...
/* ------------------------------------ */
if ( ! function_exists( 'readspec_sidebar_primary' ) ) {
	
	function readspec_sidebar_primary() {
		// Default sidebar
		$sidebar = 'primary';
...
/* ------------------------------------ */
if ( ! function_exists( 'readspec_sidebar_secondary' ) ) {

	function readspec_sidebar_secondary() {
		// Default sidebar
		$sidebar = 'secondary';
...
/*  Social links
/* ------------------------------------ */
if ( ! function_exists( 'readspec_social_links' ) ) {

	function readspec_social_links() {
...
/*  Site name/logo
/* ------------------------------------ */
if ( ! function_exists( 'readspec_site_title' ) ) {

	function readspec_site_title() {
...
/*  Blog title
/* ------------------------------------ */
if ( ! function_exists( 'readspec_blog_title' ) ) {

	function readspec_blog_title() {
		global $post;
...
/*  Related posts
/* ------------------------------------ */
if ( ! function_exists( 'readspec_related_posts' ) ) {

	function readspec_related_posts() {
		wp_reset_postdata();
		global $post;
...
/* ------------------------------------ */
if ( ! function_exists( 'readspec_post_images' ) ) {

	function readspec_post_images( $args=array() ) {
		global $post;
...
/* ------------------------------------ */
if ( ! function_exists( 'readspec_get_featured_post_ids' ) ) {

	function readspec_get_featured_post_ids() {
		$args = array(
...
/*  Body class
/* ------------------------------------ */
if ( ! function_exists( 'readspec_body_class' ) ) {

	function readspec_body_class( $classes ) {
		$classes[] = readspec_layout_class();
...
add_filter( 'body_class', 'readspec_body_class' );


/*  Excerpt ending
/* ------------------------------------ */
if ( ! function_exists( 'readspec_excerpt_more' ) ) {

	function readspec_excerpt_more( $more ) {
		if ( is_admin() ) {
			return $more;
		}
		return '&#46;&#46;&#46;';
...
add_filter( 'excerpt_more', 'readspec_excerpt_more' );


/*  Excerpt length
/* ------------------------------------ */
if ( ! function_exists( 'readspec_excerpt_length' ) ) {

	function readspec_excerpt_length( $length ) {
		if ( is_admin() ) {
			return $length;
		}
...
add_filter( 'excerpt_length', 'readspec_excerpt_length', 999 );


/*  Add responsive container to embeds
/* ------------------------------------ */	
if ( ! function_exists( 'readspec_embed_html' ) ) {

	function readspec_embed_html( $html, $url ) {
...
add_filter( 'embed_oembed_html', 'readspec_embed_html', 10, 3 );


/*  Add responsive container to jetpack embeds
/* ------------------------------------ */	
if ( ! function_exists( 'readspec_embed_html_jp' ) ) {

	function readspec_embed_html_jp( $html ) {
		return '<div class="video-container">' . $html . '</div>';
	}

}
add_filter( 'video_embed_html', 'readspec_embed_html_jp' );
...
/* ------------------------------------ */
if ( ! function_exists( 'readspec_pre_get_posts' ) ) {

	function readspec_pre_get_posts( $query ) {
		...
		if ( $query->is_home() ) {
			...
			if ( get_theme_mod('featured-posts-count','3') != '0' ) {
				// Get featured post ids
				$featured_post_ids = readspec_get_featured_post_ids();
				// Exclude posts
...
add_action( 'pre_get_posts', 'readspec_pre_get_posts' );


/*  Script for no-js / js class
/* ------------------------------------ */
if ( ! function_exists( 'readspec_html_js_class' ) ) {

	function readspec_html_js_class () {
		echo '<script>document.documentElement.className = document.documentElement.className.replace("no-js","js");</script>'. "\n";
	}
	
}
add_action( 'wp_head', 'readspec_html_js_class', 1 );


/*  Admin panel css
/* ------------------------------------ */
if ( ! function_exists( 'readspec_admin_panel_css' ) ) {
	
	function readspec_admin_panel_css() {
		global $pagenow;
...
add_action( 'admin_head', 'readspec_admin_panel_css' );


/*  TGM plugin activation
/* ------------------------------------ */
if ( ! function_exists( 'readspec_plugins' ) ) {
	
	function readspec_plugins() {
		if ( get_theme_mod('recommended-plugins','on') =='on' ) { 	
			// Add the following plugins
			$plugins = array(
				array(
					'name' => esc_html__( 'Alx Extensions', 'readspec' ),
					'slug' => 'alx-extensions',
				),
				array(
					'name' => esc_html__( 'Meta Box', 'readspec' ),
					'slug' => 'meta-box',
				),
				array(
					'name' => esc_html__( 'Regenerate Thumbnails', 'readspec' ),
					'slug' => 'regenerate-thumbnails',
				),
				array(
					'name' => esc_html__( 'WP-PageNavi', 'readspec' ),
					'slug' => 'wp-pagenavi',
				)
			);	
			tgmpa( $plugins );
...
add_action( 'tgmpa_register', 'readspec_plugins' );


/*  WooCommerce basic support
/* ------------------------------------ */
function readspec_wc_wrapper_start() {
	echo '<div class="content">';
	echo '<div class="pad">';
}
function readspec_wc_wrapper_end() {
	echo '</div>';
	echo '</div>';
}
remove_action( 'woocommerce_before_main_content', 'woocommerce_output_content_wrapper', 10);
remove_action( 'woocommerce_after_main_content', 'woocommerce_output_content_wrapper_end', 10);
add_action('woocommerce_before_main_content', 'readspec_wc_wrapper_start', 10);
add_action('woocommerce_after_main_content', 'readspec_wc_wrapper_end', 10);


/*  Accessibility IE11 fix - https://git.io/vWdr2
/* ------------------------------------ */
function readspec_skip_link_focus_fix() {
	?>
	<script>
